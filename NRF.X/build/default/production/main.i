...
char* char_to_binary_string(char character){
    ...
    sprintf(output, "%c%c%c%c%c%c%c%c""\n", (character & 0x80 ? '1' : '0'), (character & 0x40 ? '1' : '0'), (character & 0x20 ? '1' : '0'), (character & 0x10 ? '1' : '0'), (character & 0x08 ? '1' : '0'), (character & 0x04 ? '1' : '0'), (character & 0x02 ? '1' : '0'), (character & 0x01 ? '1' : '0'));
...
{
    return execute_command(reg | 0b00000000, 0b11111111);
}

void write_address(uint8_t reg, uint8_t* addr, uint8_t num)
{
    RD3 = 0;
    SPI_write(reg | 0b00100000);
...
{
    write_address(0b10100000, data, num);

    RD2 = 1;
    _delay((unsigned long)((11)*(8000000UL/4000000.0)));
    RD2 = 0;
}
...
{
    uint8_t data;
    read_address(0b01100001, &data, 1);
...
uint8_t ReadDataAvailable()
{
    ...
    uint8_t stat = write_command(0b11111111);
    return (stat & 0x40) != 0;
}
